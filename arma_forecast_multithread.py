...
def do_forecast(item):
    ...
    datas = forecast(site,factor,df)

    if datas is not None: 
        print("save to database.")
        # save_daily_forecast_data(FORECAST_START_DATETIME,site['id'],datas.values,factor['code'],model="LSTM")
    else:
...
if __name__ == '__main__':
    ...
    for site in sites:
        for factor in factors:
            ...
            items.append({'site':site,'factor':factor,'data':df})
